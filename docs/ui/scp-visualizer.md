...
- Les décodeurs actuellement réalisés couvrent Atari/IBM PC (ISO MFM/FM), Amiga MFM, Apple II GCR, Apple Macintosh GCR, Commodore GCR, Membrain MFM, AED 6200P MFM, QD MO5 MFM, Centurion MFM, NorthStar MFM, Heathkit FM, Micral N FM, E-mu Emulator FM, TYCOM FM, DEC RX02 M²FM, Arburg et Victor 9000 GCR. ISO MFM/FM associe CHRN aux champs FB/F8, restitue les données selon leur taille et contrôle les CRC d’en-tête et de données. Amiga extrait cylindre/face/secteur, restitue les 512 octets odd/even et contrôle les deux parités. Apple II extrait volume, piste et secteur, restitue les 256 octets 6-and-2 et contrôle les deux checksums. Apple Macintosh extrait cylindre, face et secteur, dénibblise 524 octets, écarte les 12 octets de tags, restitue les 512 octets utiles et contrôle les cinq checksums. Commodore extrait piste/secteur et les 256 octets GCR, puis contrôle les XOR d’en-tête et de données. Micral N extrait cylindre, secteur et 128 octets, puis contrôle le checksum à retenue de fin. Victor 9000 extrait cylindre, secteur et bloc de 512 octets, puis contrôle l’en-tête et la somme additive 16 bits des données. Les signatures rares ont été confrontées aux sources officielles HxC et les 18 extracteurs `*_track.c` sont désormais couverts.
- Le niveau exact de chaque analyseur est suivi dans `../scp-decoder-coverage.md`. NorthStar restitue les 512 octets, valide leur checksum et signale les blocs tronqués comme indisponibles; Heathkit associe ses marques FD, restitue les 256 octets inversés bit à bit et valide les checksums distincts d’en-tête et de données; Membrain associe cylindre/face/secteur à son bloc de 512 octets et valide les CRC16 d’en-tête et de données; AED 6200P associe les marques C0–C3 aux secteurs, restitue leur taille variable et valide les CRC-CCITT d’en-tête et de données; Centurion associe l’en-tête au bloc de taille variable, reconnaît la clé non chiffrée et valide les deux CRC XMODEM; QD MO5 restitue les 128 octets, valide leur somme et signale les blocs tronqués; E-mu restitue 3584 octets et valide ses deux CRC; TYCOM restitue 128 octets pour les marques F8–FB et valide ses deux CRC; DEC RX02 restitue 128 octets FM ou 256 octets M²FM pour F8–FD, applique la substitution sur 11 bits et valide ses deux CRC; Arburg restitue 2558 ou 3838 octets utiles et valide leur somme; Victor 9000 restitue les 512 octets GCR et valide ses deux contrôles.
