...
- étendre l’onglet `Explorateur`, déjà réalisé pour AmigaDOS OFS/FFS, Atari TOS FAT12/Atari DOS, Commodore CBM DOS/CP/M 3, Amstrad CPC/PCW CP/M, IBM PC FAT12 et Apple DOS/ProDOS/SOS/MFS/HFS/Lisa Office System, aux autres systèmes de fichiers et conteneurs pris en charge par GW GUI ;
- le sélecteur de l’Explorateur utilise maintenant exactement le catalogue central et le même ordre que les autres fonctions ; réaliser ensuite Acorn et les autres systèmes, puis compléter Apple avec NIB/WOZ et les variantes protégées, Atari et Amstrad avec les systèmes protégés ou différents des systèmes actuellement interprétés, afin que chaque choix affiché devienne effectivement ouvrable ;
...
- brancher les 24 encodeurs de pistes au futur moteur de conversion interne ; les lecteurs ST, MSA et ATR ainsi que la reconstruction sectorielle Atari sont réalisés, mais les écrivains de ces conteneurs, IMA, D64 et des autres formats restent à ajouter ;
- ajouter dans Conversion un parcours explicite de déprotection qui ne modifie jamais la source : la conservation RWTS18 vers les conteneurs Apple II existants NIB et WOZ est branchée ; la normalisation directe reste à faire lorsque supprimer les marques de protection suffit, ainsi qu'un convertisseur dédié par famille lorsque le chargeur doit être adapté. RWTS18 exige ce second traitement pour produire un DSK/DO amorçable, car ses 18 pages (4 608 octets) par piste ne tiennent pas sans perte dans les 16 secteurs (4 096 octets) d'une piste DOS 3.3 ; une sortie ne doit être proposée comme amorçable qu'après validation du chargeur transformé ;
- compléter la validation Apple avec au moins une capture SCP Apple II 5,25 pouces, une Apple III, une Lisa Sony et, séparément, une Lisa Twiggy; le corpus actuel ne contient pas ces quatre catégories ;
