...
- étendre l’onglet `Explorateur`, déjà réalisé pour AmigaDOS OFS/FFS, Atari TOS FAT12/Atari DOS, Commodore CBM DOS et CP/M 3 du C128 (D64/D71/D81 et SCP 1541/1571/1581), aux autres systèmes de fichiers et conteneurs pris en charge par GW GUI ;
- le sélecteur de l’Explorateur utilise maintenant exactement le catalogue central et le même ordre que les autres fonctions ; réaliser ensuite Amstrad CPC/PCW, IBM PC/FAT, Apple, Acorn et les autres systèmes, puis compléter Atari avec les systèmes protégés ou différents d’Atari DOS, afin que chaque choix affiché devienne effectivement ouvrable ;
