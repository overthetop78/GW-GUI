...
Le code actuel possède le lecteur SCP, les décodeurs, un modèle sectoriel d'encodage et les 24 encodeurs de pistes correspondants, dont le codec Apple II Broderbund RWTS18 à six secteurs de 768 octets. Pour Amiga, il possède aussi le lecteur ADF, la reconstruction sectorielle SCP, la sélection entre révolutions et le lecteur AmigaDOS. Pour Atari, il possède les lecteurs ST/MSA/ATR, la reconstruction SCP ISO FM/MFM, Atari TOS FAT12 et Atari DOS. Pour Apple, il possède les lecteurs Apple II/III et DiskCopy Macintosh/Lisa, la reconstruction SCP Apple II/Macintosh/RWTS18 et les lecteurs Apple DOS, ProDOS, SOS, MFS, HFS et Lisa Office System. Il ne possède pas encore l’équivalent pour tous les autres formats, les écrivains d’images, l'écrivain SCP complet ni le branchement de ces couches à la conversion interne et à la déprotection dédiée de l'application.
