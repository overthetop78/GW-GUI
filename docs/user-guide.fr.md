...
La famille Apple est lisible dans l’Explorateur : Apple II DOS 3.2/3.3 et ProDOS (`.d13`, `.dsk`, `.do`, `.po`, `.2mg`, `.nib`, WOZ1/WOZ2 et SCP), Apple III SOS, Macintosh MFS/HFS (`.image`, `.dc42`, `.dsk`, `.img` et SCP 400/800 Kio) et Lisa Office System dans les images DiskCopy ou SCP comportant leurs tags de pages. Les conteneurs WOZ/NIB valides restent ouvrables même lorsqu’une protection ou une organisation non standard empêche de reconstruire un catalogue fiable.
