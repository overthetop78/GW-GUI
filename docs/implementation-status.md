...
- Tout l’état utilisateur de Lecture — nom, dossier, numérotation, arguments experts et options avancées — est porté par un ViewModel observable et lié directement au XAML. La construction du nom cible, l’incrément après succès, les exclusions d’options, les profils et les arguments `gw` sont testables sans fenêtre.
