...
- L’état utilisateur principal de Lecture (nom, dossier, numérotation et arguments experts) est porté par un ViewModel observable. Le XAML y est lié directement; la construction du nom cible et l’incrément après succès sont testables sans fenêtre.
