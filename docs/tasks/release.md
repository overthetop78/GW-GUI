...
- [ ] Valider dans le workflow de release la restauration, la compilation Release et les contrôles compatibles CI après reconstitution d’une suite de tests rapides.
...
- [ ] Définir puis exécuter la suite rapide recréée dans `GWGUI.Tests` ; conserver `GWGUI.LocalDiskImageTests` hors CI.
