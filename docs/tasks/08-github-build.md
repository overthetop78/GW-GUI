...
- [x] Utiliser un runner Windows et la version .NET du projet.
- [x] Restaurer les dépendances, compiler en Release et exécuter les tests compatibles CI.
...
- [x] Vérifier que toute erreur PowerShell produit un code de sortie non nul.
- [x] Auditer ensuite le workflow de release existant et éviter les duplications fragiles.
