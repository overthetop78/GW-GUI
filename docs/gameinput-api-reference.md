...
Ce fichier conserve les informations techniques déjà vérifiées afin de ne pas refaire les mêmes recherches Internet. Avant toute nouvelle recherche GameInput, vérifier ce document et l'en-tête installé :
...
3. Lire les diagnostics de `tests/GWGUI.Tests`.
