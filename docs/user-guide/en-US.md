...
The Apple family is readable in Disk Explorer: Apple II DOS 3.2/3.3 and ProDOS (`.d13`, `.dsk`, `.do`, `.po`, `.2mg`, `.nib`, WOZ1/WOZ2, and SCP), Apple III SOS, Macintosh MFS/HFS (`.image`, `.dc42`, `.dsk`, `.img`, and 400/800 KiB SCP), and Lisa Office System in tagged DiskCopy or SCP images. Valid WOZ/NIB containers remain openable even when protection or a non-standard layout prevents reliable catalog reconstruction.
