...
- La compilation Release et 121 tests automatisés réussissent; un test STA charge réellement le XAML principal et vérifie le ViewModel, les liaisons de statut/progression et le menu Alignement.
