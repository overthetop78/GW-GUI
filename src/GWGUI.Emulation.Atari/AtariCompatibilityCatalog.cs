...
public static class AtariCompatibilityCatalog
{
    private static readonly IReadOnlyList<AtariCompatibilityDefinition> Definitions =
        AtariCompatibilityFunctions.Values(
            ...
            AtariCompatibilityFunctions.Create(AtariMachineModel.ModernXlXe320K),
            AtariCompatibilityFunctions.Create(AtariMachineModel.ModernXlXe576K),
            AtariCompatibilityFunctions.Create(AtariMachineModel.ModernXlXe1088K),
