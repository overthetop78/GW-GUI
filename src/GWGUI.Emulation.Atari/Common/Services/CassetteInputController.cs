...
internal sealed class CassetteInputController
{
    ...
    internal CassetteInputController(MachineConfiguration configuration)
    {
        _automaticReturnFrames = CassetteBootFunctions.RequiresDelayedReturn(configuration)
