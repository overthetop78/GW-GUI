...
internal static class HardwareSettingsFunctions
{
    ...
    internal static EmulationSettingsChoice ClassicRegionChoice(ClassicRegion value) => value switch
    {
        ClassicRegion.RegionFree => new(value.ToString(), HardwareSettingsConstants.RegionFreeResource),
