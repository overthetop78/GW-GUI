    ...
    private static IReadOnlyList<EmulationSettingsBlock> CreateSt(MachineConfiguration configuration)
    {
        ...
        [
            ...
            Block(SettingsDescriptionFunctionsConstants.MainMemory, EmulationMachineTab.Ram, SettingsDescriptionFunctionsConstants.ResourceMemoryMain, SettingsDescriptionFunctionsConstants.Value4, 2,
                Select(ConfigurationOptionConstants.MainMemory, EmulationMachineTab.Ram, SettingsDescriptionFunctionsConstants.MainMemory, SettingsDescriptionFunctionsConstants.ResourceMemoryMain,
                    Value(configuration, ConfigurationOptionConstants.MainMemory,
            ...
            Block(SettingsDescriptionFunctionsConstants.Firmware, EmulationMachineTab.Rom, SettingsDescriptionFunctionsConstants.ResourceFirmwareRomSystem, SettingsDescriptionFunctionsConstants.Value5, 1,
                ...
                Toggle(SettingsDescriptionFunctionsConstants.HatariFastboot, EmulationMachineTab.Rom, SettingsDescriptionFunctionsConstants.Firmware, SettingsDescriptionFunctionsConstants.ResourceAtariFastBoot,
                    Value(configuration, SettingsDescriptionFunctionsConstants.HatariFastboot, SettingsDescriptionFunctionsConstants.False) == SettingsDescriptionFunctionsConstants.True, SettingsDescriptionFunctionsConstants.True, SettingsDescriptionFunctionsConstants.False)),
