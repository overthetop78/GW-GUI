...
{
    private static IReadOnlyList<EmulationSettingsBlock> CreateHardware(MachineConfiguration configuration)
    {
        var model = HardwareModelCatalog.Get(configuration.Model);
        var blocks = new List<EmulationSettingsBlock>
        {
            ...
            Block(SettingsDescriptionFunctionsConstants.MainMemory, EmulationMachineTab.Ram, SettingsDescriptionFunctionsConstants.ResourceMemoryMain, SettingsDescriptionFunctionsConstants.Value4, 1,
                HardwareMemory(configuration, model)),
            Block(SettingsDescriptionFunctionsConstants.Video, EmulationMachineTab.Video, SettingsDescriptionFunctionsConstants.ResourceVideoSettingsDisplay, SettingsDescriptionFunctionsConstants.Value7, 2,
                Select(VideoAudioSettingsConstants.StandardOption, EmulationMachineTab.Video, SettingsDescriptionFunctionsConstants.Video,
                    SettingsDescriptionFunctionsConstants.ResourceVideoStandard, Value(configuration, VideoAudioSettingsConstants.StandardOption,
                        model.DefaultRegion.ToString()), model.Regions.Select(HardwareSettingsFunctions.HardwareRegionChoice),
        ...
        {
            var firmwareFields = HardwareFirmwareFields(configuration);
    ...
    private static EmulationSettingsField[] HardwareFirmwareFields(MachineConfiguration configuration)
    {
        var categories = HardwareModelCatalog.Get(configuration.Model).Firmware;
