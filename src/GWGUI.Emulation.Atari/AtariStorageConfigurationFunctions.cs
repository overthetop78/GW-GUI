...
public static class AtariStorageConfigurationFunctions
{
    ...
    public static (AtariMediaKind Kind, EmulationMediaSlot Slot)? PrimaryDevice(AtariMachineModel model) =>
        model switch
        {
    ...
    public static bool IsRemovable(AtariMediaKind kind) => kind is AtariMediaKind.Floppy
