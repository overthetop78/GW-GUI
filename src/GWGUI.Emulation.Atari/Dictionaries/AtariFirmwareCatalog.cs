...
public static class AtariFirmwareCatalog
{
    ...
    private static readonly IReadOnlyList<AtariFirmwareDefinition> Definitions = AtariFirmwareFunctions.Values(
        ...
        AtariFirmwareFunctions.ReplaceableRevision(AtariFirmwareConstants.Atari400OsAId,
            AtariFirmwareCategory.AtariSystemOs, AtariFirmwareCatalogConstants.RevAPAL, AtariFirmwareConstants.AtariOsAFileName,
            AtariFirmwareConstants.AtariOsAMd5, Atari400Model, NoRegions),
        AtariFirmwareFunctions.ReplaceableRevision(AtariFirmwareConstants.Atari400OsANtscId,
            AtariFirmwareCategory.AtariSystemOs, AtariFirmwareCatalogConstants.RevANTSC, AtariFirmwareConstants.AtariOsAFileName,
            AtariFirmwareConstants.AtariOsANtscMd5, Atari400Model, NoRegions),
        AtariFirmwareFunctions.ReplaceableRevision(AtariFirmwareConstants.Atari400OsBId,
            AtariFirmwareCategory.AtariSystemOs, AtariFirmwareCatalogConstants.RevBNTSC, AtariFirmwareConstants.AtariOsBFileName,
            AtariFirmwareConstants.AtariOsBMd5, Atari400Model, NoRegions),
        AtariFirmwareFunctions.ReplaceableRevision(AtariFirmwareCatalogConstants.Atari400OsbPcXformerPatched,
            AtariFirmwareCategory.AtariSystemOs, AtariFirmwareCatalogConstants.RevBNTSCPCXformerPatched,
        ...
        AtariFirmwareFunctions.ReplaceableRevision(AtariFirmwareConstants.AtariOsAId,
            AtariFirmwareCategory.AtariOsA, AtariFirmwareCatalogConstants.RevAPAL, AtariFirmwareConstants.AtariOsAFileName,
        ...
        AtariFirmwareFunctions.ReplaceableRevision(AtariFirmwareConstants.AtariOsANtscId,
            AtariFirmwareCategory.AtariOsA, AtariFirmwareCatalogConstants.RevANTSC, AtariFirmwareConstants.AtariOsAFileName,
            AtariFirmwareConstants.AtariOsANtscMd5,
            Atari800Model, NoRegions),
        AtariFirmwareFunctions.ReplaceableRevision(AtariFirmwareConstants.AtariOsBId,
            AtariFirmwareCategory.AtariOsB, AtariFirmwareCatalogConstants.RevBNTSC, AtariFirmwareConstants.AtariOsBFileName,
            AtariFirmwareConstants.AtariOsBMd5,
            Atari800Model, NoRegions),
        AtariFirmwareFunctions.ReplaceableRevision(AtariFirmwareConstants.AtariOsBPatchedId,
            AtariFirmwareCategory.AtariOsB, AtariFirmwareCatalogConstants.RevBNTSCPCXformerPatched, AtariFirmwareConstants.AtariOsBFileName,
            AtariFirmwareConstants.AtariOsBPatchedMd5,
            Atari800Model, NoRegions),
        AtariFirmwareFunctions.ReplaceableRevision(AtariFirmwareConstants.AtariXlOsId, AtariFirmwareCategory.AtariXlOs,
            AtariFirmwareCatalogConstants.BB01R2, AtariFirmwareConstants.AtariXlOsFileName, AtariFirmwareConstants.AtariXlOsMd5, XlXeModels, NoRegions),
        AtariFirmwareFunctions.ReplaceableRevision(AtariFirmwareCatalogConstants.AtariXlXeOsV3, AtariFirmwareCategory.AtariXlOs,
            AtariFirmwareCatalogConstants.BB01R3, AtariFirmwareConstants.AtariXlOsFileName, AtariFirmwareConstants.AtariXlXeOsV3Md5, XlXeModels, NoRegions),
        AtariFirmwareFunctions.ReplaceableRevision(AtariFirmwareConstants.AtariXlXeOsV4Id, AtariFirmwareCategory.AtariXlOs,
            AtariFirmwareCatalogConstants.BB01R4, AtariFirmwareConstants.AtariXlXeOsV4FileName, AtariFirmwareConstants.AtariXlXeOsV4Md5, XlXeModels, NoRegions),
        AtariFirmwareFunctions.ReplaceableRevision(AtariFirmwareCatalogConstants.AtariXlXeOsR59, AtariFirmwareCategory.AtariXlOs,
            AtariFirmwareCatalogConstants.BB01R59, AtariFirmwareConstants.AtariXlOsFileName, AtariFirmwareConstants.AtariXlXeOsR59Md5, XlXeModels, NoRegions),
        AtariFirmwareFunctions.ReplaceableRevision(AtariFirmwareCatalogConstants.AtariXlXeOsR59a, AtariFirmwareCategory.AtariXlOs,
            AtariFirmwareCatalogConstants.BB01R59A, AtariFirmwareConstants.AtariXlOsFileName, AtariFirmwareConstants.AtariXlXeOsR59AMd5, XlXeModels, NoRegions),
        AtariFirmwareFunctions.Replaceable(AtariFirmwareConstants.AtariBasicId, AtariFirmwareCategory.AtariBasic,
            AtariFirmwareConstants.AtariBasicFileName, AtariFirmwareConstants.AtariBasicMd5,
            BasicFirmwareModels, NoRegions),
        AtariFirmwareFunctions.Replaceable(AtariFirmwareConstants.Atari5200Id, AtariFirmwareCategory.Atari5200Bios,
        ...
        AtariFirmwareFunctions.ReplaceableRevision(AtariFirmwareCatalogConstants.Atari5200RevisionA, AtariFirmwareCategory.Atari5200Bios,
            AtariFirmwareCatalogConstants.RevisionA, AtariFirmwareConstants.Atari5200FileName, AtariFirmwareConstants.Atari5200RevisionAMd5,
            AtariFirmwareFunctions.Values(AtariMachineModel.Atari5200), NoRegions),
        AtariFirmwareFunctions.Replaceable(AtariFirmwareConstants.AtariXegsId, AtariFirmwareCategory.AtariXegsBios,
        ...
        AtariFirmwareFunctions.External(AtariFirmwareConstants.Atari7800Id, AtariFirmwareCategory.Atari7800Bios,
        ...
        AtariFirmwareFunctions.ExternalRevision(AtariFirmwareCatalogConstants.Atari7800Europe, AtariFirmwareCategory.Atari7800Bios,
            AtariFirmwareCatalogConstants.Europe, AtariFirmwareConstants.Atari7800FileName, AtariFirmwareConstants.Atari7800EuropeMd5,
            AtariFirmwareProvision.OptionalExternal, AtariMachineModel.Atari7800,
            AtariFirmwareEvidence.ProSystemCoreInformation, NoRegions),
        AtariFirmwareFunctions.External(AtariFirmwareConstants.LynxBootId, AtariFirmwareCategory.LynxBootRom,
        ...
        new AtariFirmwareDefinition(AtariFirmwareConstants.JaguarBootId, AtariFirmwareCategory.JaguarBootRom,
            AtariFirmwareCatalogConstants.World, AtariFirmwareConstants.JaguarBootFileName, 131072, AtariFirmwareProvision.Embedded,
