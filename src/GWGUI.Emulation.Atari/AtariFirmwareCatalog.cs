...
public static class AtariFirmwareCatalog
{
    ...
    private static readonly IReadOnlyList<AtariFirmwareDefinition> Definitions = AtariFirmwareFunctions.Values(
        ...
        AtariFirmwareFunctions.ReplaceableRevision(AtariFirmwareConstants.Atari400OsAId,
            AtariFirmwareCategory.AtariSystemOs, "Rev. A PAL", AtariFirmwareConstants.AtariOsAFileName,
        ...
        AtariFirmwareFunctions.ReplaceableRevision(AtariFirmwareConstants.Atari400OsANtscId,
            AtariFirmwareCategory.AtariSystemOs, "Rev. A NTSC", AtariFirmwareConstants.AtariOsAFileName,
        ...
        AtariFirmwareFunctions.ReplaceableRevision(AtariFirmwareConstants.Atari400OsBId,
            AtariFirmwareCategory.AtariSystemOs, "Rev. B NTSC", AtariFirmwareConstants.AtariOsBFileName,
        ...
        AtariFirmwareFunctions.ReplaceableRevision("atari-400-osb-pc-xformer-patched",
            AtariFirmwareCategory.AtariSystemOs, "Rev. B NTSC — PC Xformer patched",
        ...
        AtariFirmwareFunctions.ReplaceableRevision(AtariFirmwareConstants.AtariOsAId,
            AtariFirmwareCategory.AtariOsA, "Rev. A PAL", AtariFirmwareConstants.AtariOsAFileName,
        ...
        AtariFirmwareFunctions.ReplaceableRevision(AtariFirmwareConstants.AtariOsANtscId,
            AtariFirmwareCategory.AtariOsA, "Rev. A NTSC", AtariFirmwareConstants.AtariOsAFileName,
            AtariFirmwareConstants.AtariOsANtscMd5,
            Atari800Model, NoRegions),
        AtariFirmwareFunctions.ReplaceableRevision(AtariFirmwareConstants.AtariOsBId,
            AtariFirmwareCategory.AtariOsB, "Rev. B NTSC", AtariFirmwareConstants.AtariOsBFileName,
            AtariFirmwareConstants.AtariOsBMd5,
            Atari800Model, NoRegions),
        AtariFirmwareFunctions.ReplaceableRevision(AtariFirmwareConstants.AtariOsBPatchedId,
            AtariFirmwareCategory.AtariOsB, "Rev. B NTSC — PC Xformer patched", AtariFirmwareConstants.AtariOsBFileName,
        ...
        AtariFirmwareFunctions.ReplaceableRevision("atari-xl-xe-os-v3", AtariFirmwareCategory.AtariXlOs,
        ...
        AtariFirmwareFunctions.ReplaceableRevision("atari-xl-xe-os-r59", AtariFirmwareCategory.AtariXlOs,
            "BB01R59", AtariFirmwareConstants.AtariXlOsFileName, AtariFirmwareConstants.AtariXlXeOsR59Md5, XlXeModels, NoRegions),
        AtariFirmwareFunctions.ReplaceableRevision("atari-xl-xe-os-r59a", AtariFirmwareCategory.AtariXlOs,
        ...
        AtariFirmwareFunctions.ReplaceableRevision("atari-5200-revision-a", AtariFirmwareCategory.Atari5200Bios,
        ...
        AtariFirmwareFunctions.ExternalRevision("atari-7800-europe", AtariFirmwareCategory.Atari7800Bios,
