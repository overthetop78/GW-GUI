...
internal static class Atari800MediaFunctions
{
        ...
        IReadOnlySet<string> coreExtensions)
    {
        ...
        {
            AtariContentFunctions.Validate(media.Path, coreExtensions);
        ...
        IReadOnlyDictionary<string, string> options)
    {
        ...
        {
            Atari800MediaFunctionsConstants.Value589824 => AtariClassicModelConstants.XlXe576KModelId,
            Atari800MediaFunctionsConstants.Value1114112 => AtariClassicModelConstants.XlXe1088KModelId,
