        ...
        AtariPeripheralCategory peripheral, AtariEmulator? core = null)
    {
        ...
        if (core == AtariEmulator.Stella && peripheral is not AtariPeripheralCategory.None)
            return devices.FirstOrDefault(device =>
                       device.Description.Contains(AtariControllerPortFunctionsConstants.Automatic, StringComparison.OrdinalIgnoreCase))?.Id
        ...
        var name = peripheral switch
        {
            ...
            AtariPeripheralCategory.BoosterGrip => AtariControllerPortFunctionsConstants.BoosterGrip,
            AtariPeripheralCategory.GenesisController => AtariControllerPortFunctionsConstants.Genesis,
            AtariPeripheralCategory.Joy2BPlus => AtariControllerPortFunctionsConstants.Joy2B,
