...
internal static class AtariEnvironmentFunctions
{
    ...
    {
        AtariEnvironmentFunctionsConstants.Ja => AtariEnvironmentLanguage.Japanese, AtariEnvironmentFunctionsConstants.Fr => AtariEnvironmentLanguage.French,
        AtariEnvironmentFunctionsConstants.Es => AtariEnvironmentLanguage.Spanish, AtariEnvironmentFunctionsConstants.De => AtariEnvironmentLanguage.German,
        AtariEnvironmentFunctionsConstants.It => AtariEnvironmentLanguage.Italian, AtariEnvironmentFunctionsConstants.Nl => AtariEnvironmentLanguage.Dutch,
        AtariEnvironmentFunctionsConstants.Pt when string.Equals(CultureInfo.CurrentUICulture.Name, AtariEnvironmentFunctionsConstants.PtBR, StringComparison.OrdinalIgnoreCase)
            => AtariEnvironmentLanguage.PortugueseBrazil,
        AtariEnvironmentFunctionsConstants.Pt => AtariEnvironmentLanguage.PortuguesePortugal, AtariEnvironmentFunctionsConstants.Ru => AtariEnvironmentLanguage.Russian,
        AtariEnvironmentFunctionsConstants.Ko => AtariEnvironmentLanguage.Korean,
        AtariEnvironmentFunctionsConstants.Zh when CultureInfo.CurrentUICulture.Name.Contains(AtariEnvironmentFunctionsConstants.Hant, StringComparison.OrdinalIgnoreCase)
            => AtariEnvironmentLanguage.ChineseTraditional,
        AtariEnvironmentFunctionsConstants.Zh => AtariEnvironmentLanguage.ChineseSimplified, AtariEnvironmentFunctionsConstants.Pl => AtariEnvironmentLanguage.Polish,
        AtariEnvironmentFunctionsConstants.Vi => AtariEnvironmentLanguage.Vietnamese, AtariEnvironmentFunctionsConstants.Ar => AtariEnvironmentLanguage.Arabic,
        AtariEnvironmentFunctionsConstants.El => AtariEnvironmentLanguage.Greek, AtariEnvironmentFunctionsConstants.Tr => AtariEnvironmentLanguage.Turkish,
        AtariEnvironmentFunctionsConstants.He => AtariEnvironmentLanguage.Hebrew, AtariEnvironmentFunctionsConstants.Fi => AtariEnvironmentLanguage.Finnish,
        AtariEnvironmentFunctionsConstants.Id => AtariEnvironmentLanguage.Indonesian, AtariEnvironmentFunctionsConstants.Sv => AtariEnvironmentLanguage.Swedish,
        AtariEnvironmentFunctionsConstants.Uk => AtariEnvironmentLanguage.Ukrainian, AtariEnvironmentFunctionsConstants.Cs => AtariEnvironmentLanguage.Czech,
        AtariEnvironmentFunctionsConstants.Hu => AtariEnvironmentLanguage.Hungarian, AtariEnvironmentFunctionsConstants.Nb => AtariEnvironmentLanguage.Norwegian,
        AtariEnvironmentFunctionsConstants.Th => AtariEnvironmentLanguage.Thai,
