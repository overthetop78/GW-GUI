...
public sealed class BuiltInImageFormatCatalog : IImageFormatCatalog
{
    ...
    public BuiltInImageFormatCatalog(Func<string, string>? localize = null)
    {
        ...
        [
            ...
            F("apple2.appledos.140", "Apple II", "Apple II DOS 3.3 — 140 KiB", [E(".do", "Extension.do", "Apple DOS-order image", true), E(".dsk", "Extension.dsk.apple", "Apple disk image")], true, "APPLE2-DOS33", ".scp", ".do", ".dsk", ".2mg", ".hfe"),
            F("apple2.prodos.140", "Apple II", "Apple II ProDOS — 140 KiB", [E(".po", "Extension.po", "Apple ProDOS-order image", true), E(".2mg", "Extension.2mg", "Apple 2IMG image")], true, "APPLE2-PRODOS", ".scp", ".po", ".do", ".dsk", ".2mg", ".hfe"),
            ...
            F("mac.400", "Apple Macintosh", "Apple Macintosh/Lisa GCR — 400 KiB", [E(".image", "Extension.image.apple", "Apple DiskCopy image", true), E(".img", "Extension.img.apple", "Apple raw disk image")], true, "MAC-400", ".scp", ".image", ".img", ".hfe"),
            F("mac.800", "Apple Macintosh", "Apple Macintosh GCR — 800 KiB", [E(".image", "Extension.image.apple", "Apple DiskCopy image", true), E(".img", "Extension.img.apple", "Apple raw disk image")], true, "MAC-800", ".scp", ".image", ".img", ".hfe"),
            F("mac.1440", "Apple Macintosh", "Apple Macintosh MFM — 1.44 MiB", [E(".img", "Extension.img.apple", "Apple raw disk image", true), E(".image", "Extension.image.apple", "Apple DiskCopy image")], true, "MAC-1440", ".scp", ".image", ".img", ".hfe"),
