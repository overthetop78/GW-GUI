...
internal static class StorageSettingsFunctionsConstants
{
    ...
    internal const string OptionFloppySpeed = "puae_floppy_speed";
    internal const string OptionFloppyWriteProtection = "puae_floppy_write_protection";
    internal const string OptionFloppyWriteRedirect = "puae_floppy_write_redirect";
    internal const string Value35dd = "35dd";
    internal const string Value35DD = "3.5\" DD";
