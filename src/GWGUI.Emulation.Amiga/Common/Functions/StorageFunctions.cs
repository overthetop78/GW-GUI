...
internal static class StorageSettingsFunctions
{
        ...
        EmulationStorageSettings settings)
    {
        ...
        foreach (var device in settings.DeviceSettings ?? [])
        {
            ...
            options[StorageSettingsFunctionsConstants.OptionFloppySpeed] = floppy.Speed;
            options[StorageSettingsFunctionsConstants.OptionFloppyWriteProtection] = floppy.WriteProtected ? StorageSettingsFunctionsConstants.Enabled : StorageSettingsFunctionsConstants.Disabled;
            options[StorageSettingsFunctionsConstants.OptionFloppyWriteRedirect] = floppy.RedirectWrites ? StorageSettingsFunctionsConstants.Enabled : StorageSettingsFunctionsConstants.Disabled;
        }
        ...
        EmulationMediaSlot slot)
    {
        ...
        return new EmulationStorageDeviceSettings(slot, new FloppyDriveSettings(
            ...
            options.GetValueOrDefault(StorageSettingsFunctionsConstants.OptionFloppySpeed) ?? StorageSettingsFunctionsConstants.Value100,
            options.GetValueOrDefault(StorageSettingsFunctionsConstants.OptionFloppyWriteProtection) == StorageSettingsFunctionsConstants.Enabled,
            options.GetValueOrDefault(StorageSettingsFunctionsConstants.OptionFloppyWriteRedirect) == StorageSettingsFunctionsConstants.Enabled));
    }
}
