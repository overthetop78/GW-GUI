...
private static string Value(IReadOnlyDictionary<string, string> values, string key, string fallback) =>
    ...
    {
        var throttle = Value(options, SettingsDescriptionFunctionsConstants.OptionCpuThrottle, SettingsDescriptionFunctionsConstants.Value00);
        var multiplier = Value(options, SettingsDescriptionFunctionsConstants.OptionCpuMultiplier, SettingsDescriptionFunctionsConstants.Value0);
