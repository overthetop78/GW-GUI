namespace Hst.Amiga.FileSystems.Pfs3
{
    ...
    public class Pfs3ExtraFields
    {
        /*
     * struct Pfs3ExtraFields
{
     ...
     */
        public Pfs3ExtraFields(uint link, ushort uid, ushort gid, uint prot, uint virtualsize, uint rollpointer, ushort fsizex)
        {
            this.link = link;
            this.uid = uid;
            this.gid = gid;
        ...
        public Pfs3ExtraFields(Pfs3ExtraFields extraFields) : this(extraFields.link, extraFields.uid, extraFields.gid,
            extraFields.prot, extraFields.virtualsize, extraFields.rollpointer, extraFields.fsizex)
        {
        }

        public Pfs3ExtraFields() : this(0U, 0, 0, 0U, 0U, 0U, 0)
        {
        }
        ...
        private static int CalculateSize(Pfs3ExtraFields extraFields)
        {
            ...
            var j = 0;
            for (var i = 0; i < Pfs3SizeOf.Pfs3ExtraFieldsSize.Struct / 2; i++)
            {
                if (array[fields] != 0)
                {
                    fields++;
        ...
        /// <returns></returns>
        public static ushort[] ConvertToUShortArray(Pfs3ExtraFields extraFields)
        {
        ...
        /// <returns></returns>
        public static Pfs3ExtraFields ConvertToExtraFields(ushort[] extras)
        {
            ...
            return new Pfs3ExtraFields(link, uid, gid, prot, virtualSize, rollpointer, fsizex);
        }
    }
}
