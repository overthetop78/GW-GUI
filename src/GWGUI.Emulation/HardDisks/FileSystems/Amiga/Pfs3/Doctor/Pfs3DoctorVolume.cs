namespace Hst.Amiga.FileSystems.Pfs3.Doctor
{
    ...
    public class Pfs3DoctorVolume
    {
        ...
        /* bitmaps */
        public Pfs3DoctorBitmap mainbitmap;
        public Pfs3DoctorBitmap anodebitmap;
        public Pfs3DoctorBitmap resbitmap;

        /* full scan */
        public LinkedList<Pfs3DoctorCachedBlock> buildblocks; /* elements are of type buildblock */

        public long PartitionOffset;
        public Stream Stream;
        public Pfs3DoctorCache cache;
    }
}
