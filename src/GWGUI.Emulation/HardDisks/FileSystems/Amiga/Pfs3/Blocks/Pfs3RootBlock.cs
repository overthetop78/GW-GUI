...
typedef struct rootblock
{
    ...
    */
        [Flags]
        public enum Pfs3DiskOptions : int
        {
            /* disk options */
            MODE_HARDDISK = 1,
        ...
        /// bit 0 is harddisk mode
        /// </summary>
        public Pfs3DiskOptions Options { get; set; }
        ...
        public Pfs3RootBlockIndex idx;
        public Pfs3BitmapBlock ReservedBitmapBlock { get; set; }

        public Pfs3RootBlock()
        {
            idx = new Pfs3RootBlockIndex();
        }
    }
}
