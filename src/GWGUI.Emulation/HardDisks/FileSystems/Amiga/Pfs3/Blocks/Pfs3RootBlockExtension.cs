namespace Hst.Amiga.FileSystems.Pfs3.Blocks
{
    ...
    public class Pfs3RootBlockExtension : IPfs3Block
    {
        // struct Pfs3RootBlockExtension
        // {
        //     UWORD id;					/* id ('EX') */
        //     UWORD not_used_1;
        //     ULONG ext_options;
        ...
        //     struct Pfs3PostponedOperation tobedone;	/* postponed operation (curr. only delete) */
        ...
        public Pfs3PostponedOperation tobedone;	/* postponed operation (curr. only delete) */
        ...
        public Pfs3RootBlockExtension()
        {
            id = Pfs3Constants.EXTENSIONID;
            superindex = new uint[Pfs3Constants.MAXSUPER + 1];
            deldir = new uint[32];
