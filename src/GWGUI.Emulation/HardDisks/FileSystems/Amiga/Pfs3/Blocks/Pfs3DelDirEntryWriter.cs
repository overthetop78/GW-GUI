namespace Hst.Amiga.FileSystems.Pfs3.Blocks
{
    ...
    public static class Pfs3DelDirEntryWriter
    {
        public static void Write(byte[] data, int offset, Pfs3DelDirEntry delDirEntry)
        {
            ...
            Pfs3DateHelper.WriteDate(delDirEntry.CreationDate, data, offset + 0x8);
