namespace Hst.Amiga.FileSystems.Pfs3
{
    ...
    public static class Pfs3RootBlockExtensionWriter
    {
        public static byte[] BuildBlock(Pfs3RootBlockExtension rootblockextension, Pfs3GlobalData g)
        {
            ...
            BigEndianConverter.ConvertUInt16ToBytes(Pfs3Constants.EXTENSIONID, blockBytes, 0); // 0
            ...
            Pfs3DateHelper.WriteDate(rootblockextension.RootDate, blockBytes, 16); // 16
            Pfs3DateHelper.WriteDate(rootblockextension.VolumeDate, blockBytes, 22); // 22
            ...
            Pfs3DateHelper.WriteDate(rootblockextension.dd_creationdate, blockBytes, 136); // 136
