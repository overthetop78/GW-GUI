namespace Hst.Amiga.FileSystems.Pfs3
{
    ...
    public static class Pfs3Constants
    {
 ...
 * place you can find rootblock
 */
        public static int SIZEOF_RESBLOCK(Pfs3GlobalData g) => g.RootBlock.ReservedBlksize;
        //public const long SIZEOF_CACHEDBLOCK = (sizeof(struct Pfs3DoctorCachedBlock) + SIZEOF_RESBLOCK);
...
/* info id's: delfile, deldir and flushed reference */
        ...
        public static uint RESCLUSTER(Pfs3GlobalData g) => g.currentvolume.rescluster;
 ...
 */
        ...
        //public const int  MAX_ENTRYSIZE (sizeof(struct Pfs3DirEntry) + FNSIZE + CMSIZE + 34)
