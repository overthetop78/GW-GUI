namespace Hst.Amiga.FileSystems.Pfs3
{
    ...
    public static class Pfs3RootBlockExtensionReader
    {
        public static Pfs3RootBlockExtension Parse(byte[] blockBytes)
        {
            var id = BigEndianConverter.ConvertBytesToUInt16(blockBytes);
            if (id != Pfs3Constants.EXTENSIONID)
            {
            ...
            var root_date = Pfs3DateHelper.ReadDate(blockBytes, 0x10);
            var volume_date = Pfs3DateHelper.ReadDate(blockBytes, 0x16);
            ...
            var offset = 0x40;
            var superIndex = new uint[Pfs3Constants.MAXSUPER + 1];
            ...
            var dd_creationdate = Pfs3DateHelper.ReadDate(blockBytes, 0x88);
            ...
            return new Pfs3RootBlockExtension
            {
                id = id,
                ...
                tobedone = new Pfs3PostponedOperation
                {
