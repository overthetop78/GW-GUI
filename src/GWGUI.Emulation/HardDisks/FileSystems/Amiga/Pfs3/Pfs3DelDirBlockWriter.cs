namespace Hst.Amiga.FileSystems.Pfs3
{
    ...
    public static class Pfs3DelDirBlockWriter
    {
        public static byte[] BuildBlock(Pfs3DelDirBlock delDirBlock, Pfs3GlobalData g)
        {
            ...
            Pfs3DateHelper.WriteDate(delDirBlock.CreationDate, blockBytes, 0x1a);

            var offset = 0x20; // first del dir entry offset
            foreach (var entry in delDirBlock.entries)
            {
                Pfs3DelDirEntryWriter.Write(blockBytes, offset, entry);
