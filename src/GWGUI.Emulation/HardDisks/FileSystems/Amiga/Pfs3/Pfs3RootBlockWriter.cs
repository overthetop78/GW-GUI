namespace Hst.Amiga.FileSystems.Pfs3
{
    ...
    public static class Pfs3RootBlockWriter
    {
        public static byte[] BuildBlock(Pfs3RootBlock rootBlock, Pfs3GlobalData g)
        {
            ...
            Pfs3DateHelper.WriteDate(rootBlock.CreationDate, blockBytes, 0xc); // 12
