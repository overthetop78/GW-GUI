...
struct Pfs3FileInfo
{
	struct Pfs3DirEntry *direntry;      // pointer wijst naar direntry binnen gecached dirblock
	struct cdirblock *dirblock;     // pointer naar gecached dirblock
};
         */

        public Pfs3DirEntry direntry;      // pointer wijst naar direntry binnen gecached dirblock
        public Pfs3CachedBlock dirblock;     // pointer naar gecached dirblock
    }
}
