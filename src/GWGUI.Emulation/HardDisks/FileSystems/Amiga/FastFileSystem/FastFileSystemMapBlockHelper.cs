namespace Hst.Amiga.FileSystems.FastFileSystem
{
    ...
    public static class FastFileSystemMapBlockHelper
    {
        /// <summary>
        ...
        {
            uint mapEntry = 0;
            for (var i = 0; i < FastFileSystemConstants.BitmapsPerULong && offset + i < blockFreeMap.Length; i++)
            {
        ...
        public static void SetBlock(FastFileSystemBitmapBlock bitmapBlock, int block, FastFileSystemBitmapBlock.FastFileSystemBlockState state)
        {
            ...
            bitmapBlock.Map[mapEntryOffset] = state == FastFileSystemBitmapBlock.FastFileSystemBlockState.Free
