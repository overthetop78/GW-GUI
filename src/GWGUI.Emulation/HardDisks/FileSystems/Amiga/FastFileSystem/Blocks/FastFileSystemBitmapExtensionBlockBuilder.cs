namespace Hst.Amiga.FileSystems.FastFileSystem.Blocks
{
    ...
    public static class FastFileSystemBitmapExtensionBlockBuilder
    {
        public static byte[] Build(FastFileSystemBitmapExtensionBlock bitmapExtensionBlock, uint blockSize)
        {
