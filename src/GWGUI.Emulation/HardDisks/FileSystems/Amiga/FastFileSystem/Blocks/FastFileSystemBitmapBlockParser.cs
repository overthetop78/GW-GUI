namespace Hst.Amiga.FileSystems.FastFileSystem.Blocks
{
    ...
    public static class FastFileSystemBitmapBlockParser
    {
        public static FastFileSystemBitmapBlock Parse(byte[] blockBytes)
        {
            ...
            return new FastFileSystemBitmapBlock(blockBytes.Length)
            {
                Checksum = checksum,
