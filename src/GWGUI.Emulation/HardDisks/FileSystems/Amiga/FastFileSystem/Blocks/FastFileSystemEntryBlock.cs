namespace Hst.Amiga.FileSystems.FastFileSystem.Blocks
{
    ...
    public class FastFileSystemEntryBlock : IFastFileSystemBlock, IFastFileSystemHeaderBlock, IFastFileSystemEntryBlock
    {
        ...
        public FastFileSystemEntryBlock(int fileSystemBlockSize)
        {
            Type = FastFileSystemConstants.T_HEADER;
