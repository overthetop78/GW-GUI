namespace Hst.Amiga.FileSystems.FastFileSystem.Blocks
{
    ...
    public static class FastFileSystemBitmapExtensionBlockParser
    {
        public static FastFileSystemBitmapExtensionBlock Parse(byte[] blockBytes)
        {
            ...
            return new FastFileSystemBitmapExtensionBlock
            {
