namespace Hst.Amiga.FileSystems.FastFileSystem.Blocks
{
    ...
    /// </summary>
    public class FastFileSystemBitmapBlock : IFastFileSystemBlock
    {
        public enum FastFileSystemBlockState
        {
            Used,
            Free
        }
        ...
        public FastFileSystemBitmapBlock(int fileSystemBlockSize)
        {
