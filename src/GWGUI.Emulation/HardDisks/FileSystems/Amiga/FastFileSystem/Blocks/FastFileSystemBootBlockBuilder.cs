namespace Hst.Amiga.FileSystems.FastFileSystem.Blocks
{
    ...
    public static class FastFileSystemBootBlockBuilder
    {
        public static byte[] Build(FastFileSystemBootBlock bootBlock, int blockSize)
        {
            ...
            FastFileSystemBootBlockChecksumHelper.UpdateChecksum(blockBytes, 4);
