namespace Hst.Amiga.FileSystems.FastFileSystem
{
    ...
    public class FastFileSystemVolumeState
    {
        ...
        public FastFileSystemRootBlock RootBlock { get; set; }
        ...
        public FastFileSystemBitmapBlock[] BitmapTable { get; set; }
        ...
        public FastFileSystemVolumeState()
        {
            Logs = new List<string>();

            BitmapTable = Array.Empty<FastFileSystemBitmapBlock>();
