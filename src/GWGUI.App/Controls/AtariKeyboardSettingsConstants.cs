...
internal static class AtariKeyboardSettingsConstants
{
    ...
    internal static readonly IReadOnlyDictionary<EmulationKey, EmulationKey> Defaults =
        new Dictionary<EmulationKey, EmulationKey>
        {
            [EmulationKey.Help] = EmulationKey.Insert, [EmulationKey.AtariUndo] = EmulationKey.Home,
            [EmulationKey.AtariBreak] = EmulationKey.End, [EmulationKey.AtariOption] = EmulationKey.F2,
            [EmulationKey.AtariSelect] = EmulationKey.F3, [EmulationKey.AtariStart] = EmulationKey.F1
        };
}
