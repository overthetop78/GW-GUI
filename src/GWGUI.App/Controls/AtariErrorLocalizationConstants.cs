...
internal static class AtariErrorLocalizationConstants
{
    internal const string CoreNotFoundResource = "Emulation.Atari.Error.CoreNotFound";
    internal const string CoreRejectedResource = "Emulation.Atari.Error.CoreRejected";
    ...
    internal const string StateInvalidResource = "Emulation.Atari.Error.StateInvalid";
    internal const string StateIncompatibleResource = "Emulation.Atari.Error.StateIncompatible";
