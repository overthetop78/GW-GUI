...
internal static class AtariHardwareSettingsConstants
{
    ...
    internal const string CpuResource = "Emulation.Cpu.Model";
    internal const string FrequencyResource = "Emulation.Cpu.Speed";
    internal const string PrecisionResource = "Emulation.Cpu.Precision";
    ...
    internal const string ForcedResource = "Emulation.Atari.Unavailable.ForcedByModel";
    ...
    internal const string CoreResource = "Emulation.Core.Name";
