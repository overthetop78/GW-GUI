...
internal static class AtariVideoAudioSettingsConstants
{
    ...
    internal const string AudioQualityLowResource = "Emulation.Audio.Quality.Low";
    internal const string AudioQualityNormalResource = "Emulation.Audio.Quality.Normal";
    internal const string AudioQualityHighResource = "Emulation.Audio.Quality.High";
    ...
    internal const string StandardOptionKey = GWGUI.Emulation.Atari.AtariConfigurationOptionConstants.VideoStandard;
    internal const string RegionOptionKey = AtariHardwareSettingsConstants.RegionOptionKey;
    internal const string ResolutionOptionKey = GWGUI.Emulation.Atari.AtariConfigurationOptionConstants.VideoResolution;
    ...
    internal const string AudioOutputOptionKey = GWGUI.Emulation.Atari.AtariConfigurationOptionConstants.AudioOutput;
    internal const string AudioLatencyOptionKey = GWGUI.Emulation.Atari.AtariConfigurationOptionConstants.AudioLatency;
    internal const string AudioVolumeOptionKey = GWGUI.Emulation.Atari.AtariConfigurationOptionConstants.AudioVolume;
    ...
    internal const string DefaultOutputValue = GWGUI.Emulation.Atari.AtariConfigurationOptionConstants.DefaultAudioOutput;
