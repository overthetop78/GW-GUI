...
public sealed class CpmFileSystemReader : IFileSystemReader
{
    ...
    private static FileSystemVolume BuildVolume(IMediaSectorImage image, CpmDirectoryReader.LogicalImage logical, CpmLayout layout, CpmDirectoryReader.DirectoryResult directory)
    {
