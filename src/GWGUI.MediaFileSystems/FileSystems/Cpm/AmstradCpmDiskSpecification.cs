...
public sealed record AmstradCpmDiskSpecification(byte Tracks, byte SectorsPerTrack, int SectorSize, byte ReservedTracks, int AllocationSize, byte DirectoryBlocks)
{
