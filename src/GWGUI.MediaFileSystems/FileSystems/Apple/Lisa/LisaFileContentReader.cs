...
internal static class LisaFileContentReader
{
    ...
    public static IEnumerable<(ushort FileId, LisaFileContent File)> ReadAll(IMediaSectorImage image, List<string> warnings)
    {
    ...
    private static LisaFileContent Read(ushort fileId, IEnumerable<(IMediaSectorBlock Block, int PageNumber)> source, List<string> warnings)
    {
