...
internal static class MacMfsForkReader
{
    ...
    public static MacMfsForkResult Read(IMediaSectorImage image, MacMfsAllocationMap map, int allocationStart, uint allocationSize, int firstCluster, uint logicalLength, string file, string fork, ICollection<string> warnings)
    {
