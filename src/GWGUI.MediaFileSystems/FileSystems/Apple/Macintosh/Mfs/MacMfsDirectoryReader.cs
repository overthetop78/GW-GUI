...
namespace GWGUI.MediaFileSystems.FileSystems.Apple.Macintosh.Mfs;
...
internal static class MacMfsDirectoryReader
{
    ...
    public static IReadOnlyList<FileSystemEntry> Read(IMediaSectorImage image, int directoryStart, int directoryLength, MacMfsAllocationMap map, int allocationStart, uint allocationSize, List<string> warnings)
    {
    ...
    private static void ReadBlock(IMediaSectorImage image, int blockNumber, MacMfsAllocationMap map, int allocationStart, uint allocationSize, ICollection<FileSystemEntry> entries, List<string> warnings)
    {
