...
namespace GWGUI.MediaFileSystems.FileSystems.Apple.Macintosh.Hfs;
...
internal static class MacHfsCatalogReader
{
    ...
    public static IReadOnlyList<MacHfsCatalogRecord> Read(IReadOnlyList<byte> catalog, IMediaSectorImage image, int allocationStart, uint allocationSize, List<string> warnings)
    {
    ...
    private static void ReadNode(ReadOnlySpan<byte> node, IMediaSectorImage image, int allocationStart, uint allocationSize, ICollection<MacHfsCatalogRecord> records, List<string> warnings)
    {
    ...
    private static void ReadRecord(ReadOnlySpan<byte> node, int start, int end, IMediaSectorImage image, int allocationStart, uint allocationSize, ICollection<MacHfsCatalogRecord> records, List<string> warnings)
    {
    ...
    private static void ReadFile(ReadOnlySpan<byte> node, int offset, uint parentId, string name, IMediaSectorImage image, int allocationStart, uint allocationSize, ICollection<MacHfsCatalogRecord> records, List<string> warnings)
    {
