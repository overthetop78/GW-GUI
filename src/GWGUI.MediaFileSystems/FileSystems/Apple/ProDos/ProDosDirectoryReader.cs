...
internal static class ProDosDirectoryReader
{
    ...
    public static ProDosDirectoryResult Read(IMediaSectorImage image, int firstBlock, List<string> warnings, ISet<int> globalVisited, int depth)
    {
    ...
    private static void ReadEntry(IMediaSectorImage image, ReadOnlySpan<byte> bytes, int offset, List<string> warnings, ISet<int> globalVisited, int depth, ICollection<FileSystemEntry> entries)
    {
