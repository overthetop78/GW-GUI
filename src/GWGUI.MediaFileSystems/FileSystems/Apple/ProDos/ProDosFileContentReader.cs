...
internal static class ProDosFileContentReader
{
    ...
    public static ProDosFileContent Read(IMediaSectorImage image, ProDosStorageType storageType, int keyBlock, int length, string fileName, List<string> warnings)
    {
    ...
    private static bool ReadIndex(IMediaSectorImage image, int blockNumber, int pointerCount, string fileName, ProDosStorageType storageType, ICollection<int> output, ISet<int> indexBlocks, ICollection<string> warnings)
    {
    ...
    private static bool ReadTree(IMediaSectorImage image, int masterBlock, int requiredBlocks, string fileName, ProDosStorageType storageType, ICollection<int> output, ISet<int> indexBlocks, ICollection<string> warnings)
    {
