...
namespace GWGUI.MediaFileSystems.FileSystems.Amiga.FlatArchive;
...
public sealed class AmigaFlatResourceArchiveReader : IFileSystemReader
{
    ...
    {
        MediaImageFormatIds.AmigaDos,
        MediaImageFormatIds.AmigaDosHighDensity
    }.ToFrozenSet(StringComparer.OrdinalIgnoreCase);

    /// <inheritdoc />
    public bool CanRead(IMediaSectorImage image) => AmigaFlatResourceDirectoryReader.TryRead(image, out _);
