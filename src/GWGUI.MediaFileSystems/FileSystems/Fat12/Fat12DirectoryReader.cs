...
internal static class Fat12DirectoryReader
{
    ...
    public static IReadOnlyList<FileSystemEntry> Read(IMediaSectorImage image, FatSectorRange directory, FatSectorRange fat, Fat12Layout layout, List<string> warnings, int depth, string path)
    {
    ...
    private static FileSystemEntry ReadEntry(IMediaSectorImage image, FatSectorRange directory, FatSectorRange fat, Fat12Layout layout, List<string> warnings, int depth, string path, int offset, string name, FatDirectoryAttributes attributes)
    {
