...
internal static class Fat12FatReader
{
    ...
    public static bool HasReadableCopy(IMediaSectorImage image, Fat12Layout layout, byte mediaDescriptor)
    {
    ...
    public static FatSectorRange ReadBest(IMediaSectorImage image, Fat12Layout layout, byte mediaDescriptor, List<string> warnings)
    {
