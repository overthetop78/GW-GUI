...
public static class AcornFileCoreLayout
{
    ...
    public const int DiscRecordBitLength = DiscRecordLength * BitConstants.BitsPerByte;
    ...
    public const int FreeLinkBitOffset = BitConstants.BitsPerByte;
    ...
    public const int FragmentIdShift = BitConstants.BitsPerByte;
    ...
    public const int IntraByteBitMask = BitConstants.BitsPerByte - 1;
}
