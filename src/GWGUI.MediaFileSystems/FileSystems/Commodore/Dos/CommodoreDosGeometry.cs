...
public static class CommodoreDosGeometry
{
    ...
    public static bool TryToLogicalBlock(IMediaSectorImage image, int track, int sector, out int logicalBlock)
    {
        try
        {
    ...
    public static int ToLogicalBlock(IMediaSectorImage image, int track, int sector)
    {
        if (image.FormatId == MediaImageFormatIds.Commodore1581) return Commodore1581Geometry.ToLogicalBlock(track, sector);
