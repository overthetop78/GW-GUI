...
internal static class Commodore1541BamReader
{
    ...
    public static CommodoreDosFreeSpace Read(IMediaSectorImage image, List<string> warnings)
    {
        var free = 0;
    ...
    private static bool ReadSide(IMediaSectorImage image, int track, int trackCount, ref int free, List<string> warnings)
    {
