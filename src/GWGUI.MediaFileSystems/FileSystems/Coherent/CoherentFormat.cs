...
public static class CoherentFormat
{
    ...
    public static uint ReadCanonicalUInt32(ReadOnlySpan<byte> value)
    {
        ...
        return (uint)(value[LowByteOffset] | value[LowMiddleByteOffset] << BitConstants.BitsPerByte | value[HighMiddleByteOffset] << 16 | value[HighByteOffset] << 24);
    }
