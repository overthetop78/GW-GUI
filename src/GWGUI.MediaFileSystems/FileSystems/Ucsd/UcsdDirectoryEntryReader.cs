...
internal static class UcsdDirectoryEntryReader
{
    ...
    public static UcsdDirectoryEntriesResult Read(IMediaSectorImage image, UcsdDirectoryHeader header, UcsdBlockReadResult directory, List<string> warnings)
    {
    ...
    private static void ReadEntry(IMediaSectorImage image, UcsdDirectoryHeader header, UcsdBlockReadResult directory, byte[] bytes, int index, ICollection<FileSystemEntry> entries, ISet<int> usedBlocks, ICollection<string> warnings, ref bool valid)
    {
