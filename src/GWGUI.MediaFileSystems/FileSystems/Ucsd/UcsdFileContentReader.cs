...
internal static class UcsdFileContentReader
{
    ...
    public static UcsdFileContent Read(IMediaSectorImage image, int firstBlock, int lastBlockExclusive, int lastBytes, string name, ICollection<string> warnings)
    {
