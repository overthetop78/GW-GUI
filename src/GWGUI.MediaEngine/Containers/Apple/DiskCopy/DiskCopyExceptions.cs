...
internal static class DiskCopyExceptions
{
    ...
    public static InvalidDataException TruncatedHeader() => new("The DiskCopy header is truncated.");
    ...
    public static InvalidDataException InvalidPrivateWord(ushort observedPrivateWord, ushort expectedPrivateWord) => new($"The DiskCopy private word is 0x{observedPrivateWord:X4}; expected 0x{expectedPrivateWord:X4}.");
    ...
    public static InvalidDataException InvalidPayload() => new("The DiskCopy payload is invalid.");
    ...
    public static InvalidDataException UnrecognizedDataAndTags() => new("The DiskCopy image is neither a recognized Macintosh/ProDOS image nor a tagged Lisa image.");
    ...
    public static InvalidDataException InvalidDataChecksum(uint storedChecksum, uint calculatedChecksum) => new($"The DiskCopy data checksum is invalid: stored 0x{storedChecksum:X8}, calculated 0x{calculatedChecksum:X8}.");
    ...
    /// <returns>L’exception contenant les deux checksums comparés.</returns>
    public static InvalidDataException InvalidTagChecksum(uint storedChecksum, uint calculatedChecksum) => new($"The DiskCopy tag checksum is invalid: stored 0x{storedChecksum:X8}, calculated 0x{calculatedChecksum:X8}.");
    ...
    public static ArgumentException InvalidChecksumByteCount(int byteCount, string parameterName) => new($"A DiskCopy checksum requires an even number of bytes, but received {byteCount}.", parameterName);
}
