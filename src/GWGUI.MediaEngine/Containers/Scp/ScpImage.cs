...
{
    /// <summary>
    /// Initialise une image SCP en copiant les pistes fournies.
    /// </summary>
    ...
    /// <exception cref="ArgumentNullException"><paramref name="tracks"/> est nul.</exception>
    ...
    /// <summary>
    /// Obtient l'en-tête SCP validé.
    /// </summary>
    public ScpHeader Header { get; }

    /// <summary>
    /// Obtient les pistes présentes et interprétées depuis la table du conteneur.
    /// </summary>
    public IReadOnlyList<ScpTrack> Tracks { get; }

    /// <summary>
    /// Indique si la somme de contrôle respecte les règles du format SCP.
    /// </summary>
    public bool ChecksumValid { get; }

    /// <summary>
    /// Obtient la taille totale du conteneur source, en octets.
    /// </summary>
