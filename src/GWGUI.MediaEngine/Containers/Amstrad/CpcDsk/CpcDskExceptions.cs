...
internal static class CpcDskExceptions
{
    ...
    public static InvalidDataException TruncatedHeader() => new("The Amstrad DSK header is truncated.");
    ...
    public static InvalidDataException UnrecognizedSignature() => new("The file is not a CPCEMU DSK image.");
    ...
    public static InvalidDataException TruncatedTrack(int trackIndex) => new($"Amstrad DSK track {trackIndex} is truncated.");
    ...
    public static InvalidDataException InvalidTrackHeader(int trackIndex) => new($"Amstrad DSK track {trackIndex} has an invalid header.");
    ...
    /// <returns>L’exception contenant l’index de la piste invalide.</returns>
    public static InvalidDataException InvalidSectorTable(int trackIndex) => new($"Amstrad DSK track {trackIndex} has an invalid sector table.");
    ...
    public static InvalidDataException TruncatedSector(int cylinder, int head, int sectorId) => new($"Amstrad DSK sector {cylinder}:{head}:{sectorId} is truncated.");
