...
internal static class TrackEncodingLimits
{
    ...
    public const byte MinimumSectorSizeCode = GWGUI.MediaEngine.Images.Models.Sectors.SectorSizeCode.MinimumCode;
    /// <summary>Plus grand code de taille sectorielle ISO admis.</summary>
    public const byte MaximumSectorSizeCode = GWGUI.MediaEngine.Images.Models.Sectors.SectorSizeCode.MaximumCode;
}
