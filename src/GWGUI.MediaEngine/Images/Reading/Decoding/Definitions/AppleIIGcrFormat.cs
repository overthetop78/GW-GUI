...
internal static class AppleIIGcrFormat
{
    ...
    public const int PrologueBitCount = PrologueByteCount * GWGUI.MediaEngine.Functions.BitPrimitives.BitsPerByte;
    ...
    public const int EncodedAddressBitCount = EncodedAddressByteCount * GWGUI.MediaEngine.Functions.BitPrimitives.BitsPerByte;
