...
namespace GWGUI.MediaEngine.Images.Reading.Decoding.I86f;

/// <summary>D̩code les pistes d'un conteneur 86F et construit leur image sectorielle ISO FM ou MFM.</summary>
/// <param name="reader">Lecteur du conteneur et de ses cellules de bits.</param>
/// <param name="decoders">Registre des d̩codeurs de flux ISO.</param>
public sealed class I86fSectorImageReader(I86fReader reader, FluxDecoderRegistry decoders)
{
    /// <summary>Lit un conteneur 86F, choisit le d̩codeur de chaque piste et construit l'image sectorielle.</summary>
    ...
    /// <exception cref="InvalidDataException">Le conteneur est invalide ou aucun secteur n'est d̩codable.</exception>
    /// <exception cref="OverflowException">Un calcul de taille ou de position d̩passe la capacit̩ d'un entier.</exception>
    ...
    public async Task<SectorImage> ReadAsync(string path, CancellationToken cancellationToken = default)
    {
        ...
        return IsoSectorImageBuilder.CreateUniform(formatId, candidates, measured.SectorSize, measured.Cylinders, measured.Heads, measured.SectorsPerTrack, address => measured.ZeroBased ? Array.IndexOf(measured.SectorOrder, address.Number) : address.Number - 1);
    }

    /// <summary>S̩lectionne le d̩codeur ISO correspondant aux drapeaux d'une piste 86F.</summary>
    /// <param name="flags">Drapeaux de la piste.</param>
    /// <returns>L'identifiant du d̩codeur ISO MFM ou ISO FM.</returns>
