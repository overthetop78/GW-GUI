namespace GWGUI.MediaEngine.Images.Formats.Floppy.Nib;
...
internal static class NibLayout
{
    ...
    public const int MaximumTrackBitCount = TrackLengthBytes * GWGUI.MediaEngine.Functions.BitPrimitives.BitsPerByte;
}
