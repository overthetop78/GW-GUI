namespace GWGUI.MediaEngine.Images.Formats.Floppy.TwoImg;
...
internal static class TwoImgExceptions
{
    ...
    public static InvalidDataException InvalidSignature() => new("The 2IMG signature is invalid.");
    ...
    public static NotSupportedException UnsupportedVersion(ushort version) => new($"The 2IMG version {version} is not supported.");

    /// <summary>Crée l’erreur signalant un en-tête 2IMG tronqué.</summary>
    /// <returns>L’exception décrivant l’en-tête incomplet.</returns>
    public static InvalidDataException TruncatedHeader() => new("The 2IMG header is truncated.");
    ...
    public static InvalidDataException InvalidDataRange() => new("The 2IMG data range is invalid.");
    ...
    public static NotSupportedException UnsupportedImageFormat(TwoImgImageFormat imageFormat) => new($"The 2IMG image format {imageFormat} is not supported.");
}
