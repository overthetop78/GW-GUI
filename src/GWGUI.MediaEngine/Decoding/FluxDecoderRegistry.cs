...
{
    private readonly System.Runtime.CompilerServices.ConditionalWeakTable<ScpRevolution, System.Collections.Concurrent.ConcurrentDictionary<string, Lazy<FluxDecodeResult>>> _cache = new();
    ...
    public FluxDecodeResult DecodeAutomatic(ScpRevolution revolution)
    {
