...
public static class DiskImageRecognitionExceptions
{
    ...
    public static NotSupportedException UnsupportedExtension(string extension) =>
        new($"The image extension '{extension}' is not supported by the explorer yet.");
    ...
    public static NotSupportedException UnsupportedRequestedFormat(string requestedFormat, string policyName) =>
        new($"The selected format '{requestedFormat}' is not supported by recognition policy '{policyName}'.");
    ...
    public static InvalidDataException PolicyRejectedContent(
        string extension,
        string policyName,
        Exception innerException) =>
        new($"Recognition policy '{policyName}' rejected the content of image extension '{extension}'.", innerException);
}
