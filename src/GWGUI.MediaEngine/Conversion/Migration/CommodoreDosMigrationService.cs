...
public sealed class CommodoreDosMigrationService(CommodoreDosContainerWriter d64D71Writer, D81Writer d81Writer)
{
    ...
    private async Task WriteImageAsync(Representations.Sectors.SectorImage image, string outputPath, string targetFormatId, CancellationToken cancellationToken)
    {
