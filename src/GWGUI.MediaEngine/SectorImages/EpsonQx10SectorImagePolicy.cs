...
internal static class EpsonQx10SectorImagePolicy
{
    ...
    public static bool TryDetectFormat(IReadOnlyDictionary<SectorAddress, List<IsoSectorCandidate>> candidates, out string formatId) => EpsonQx10FormatDetector.TryDetect(candidates, out formatId);
}
