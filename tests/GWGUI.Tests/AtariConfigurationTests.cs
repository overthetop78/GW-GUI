...
public sealed class AtariConfigurationTests
{
    public static TheoryData<AtariMachineModel, AtariCoreKind, AtariMachineFamily> ModelMappings => new()
    {
        ...
        { AtariMachineModel.ModernXlXe320K, AtariCoreKind.Atari800, AtariMachineFamily.EightBit },
        { AtariMachineModel.ModernXlXe576K, AtariCoreKind.Atari800, AtariMachineFamily.EightBit },
        { AtariMachineModel.ModernXlXe1088K, AtariCoreKind.Atari800, AtariMachineFamily.EightBit },
