...
public sealed class ArburgDecoderTests
{
    ...
    private static FluxDecodeResult Decode(IReadOnlyList<bool> bits) => new ArburgDecoder().Decode(GWGUI.MediaEngine.Flux.FluxRevolutionFactory.Create(bits, 40, 8_000_000));
