...
public sealed class AtariClassicModelCatalogTests
{
    public static TheoryData<AtariMachineModel, string, AtariCoreKind, long, AtariClassicCpu> Models => new()
    {
        { AtariMachineModel.Atari400, AtariClassicModelConstants.Atari400And800ModelId, AtariCoreKind.Atari800,
            AtariClassicModelConstants.FortyEightKibibytes, AtariClassicCpu.Mos6502C },
        ...
        { AtariMachineModel.ModernXlXe320K, AtariClassicModelConstants.Modern320KModelId, AtariCoreKind.Atari800,
            AtariClassicModelConstants.ThreeHundredTwentyKibibytes, AtariClassicCpu.Mos6502C },
        { AtariMachineModel.ModernXlXe576K, AtariClassicModelConstants.Modern576KModelId, AtariCoreKind.Atari800,
            AtariClassicModelConstants.FiveHundredSeventySixKibibytes, AtariClassicCpu.Mos6502C },
        { AtariMachineModel.ModernXlXe1088K, AtariClassicModelConstants.Modern1088KModelId, AtariCoreKind.Atari800,
            AtariClassicModelConstants.OneThousandEightyEightKibibytes, AtariClassicCpu.Mos6502C },
