...
{
    public static IEnumerable<object[]> Targets => GWGUI.MediaEngine.Conversion.Migration.FileSystemMigrationTargetCatalog.All.Select(target=>new object[]{target.FormatId,target.Extension});
